...
class ReservationController extends Controller
{
    ...
    public function approveReservation($id)
    {
        ...
        Mail::to($reservation->user($id))->send(new ReservationStatusMail($reservation, 'approuvé'));

        return redirect()->route('idees.index')->with('success', 'Reservation approuvée avec succès !');
    }
    ...
    public function rejectReservation($id)
    {
        ...
        Mail::to($reservation->user($id))->send(new ReservationStatusMail($reservation, 'refusé'));

        return redirect()->route('reservation.index')->with('success', 'Idée refusée avec succès !');
    }
}
